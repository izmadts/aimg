...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">
                <i class="fas fa-arrow-up text-green-600 mr-2"></i> Add Income
            </h1>
            <p class="text-sm text-gray-500">Record an income transaction</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-3xl">
        <form method="POST" action="{{ route('income-expense.store-income') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <!-- Income Account -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Income Account *</label>
            ...
            <div class="flex justify-end space-x-4 mt-6 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-6 rounded-lg transition">
                    <i class="fas fa-save mr-2"></i> Record Income
                </button>
            </div>
        </form>
    </div>
