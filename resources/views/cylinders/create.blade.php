...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Add Cylinder</h1>
            <p class="text-sm text-gray-500">Add a new cylinder to inventory</p>
        </div>
        ...
        <form method="POST" action="{{ route('cylinders.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select name="gas_product_id" id="gas_product_id" required
                        ...
                        @foreach($gasProducts as $product)
                            <option value="{{ $product->id }}" 
                                    ...
                                    {{ old('gas_product_id') == $product->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="type" id="type" required
                        ...
                        <option value="Extra Small" data-premium="1500" {{ old('type') == 'Extra Small' ? 'selected' : '' }}>Extra Small (1.7 m3)</option>
                        <option value="Small" data-premium="2000" {{ old('type') == 'Small' ? 'selected' : '' }}>Small (3.4 m3)</option>
                        <option value="Medium" data-premium="3000" {{ old('type') == 'Medium' ? 'selected' : '' }}>Medium (8.8 m3)</option>
                        <option value="Large" data-premium="3500" {{ old('type') == 'Large' ? 'selected' : '' }}>Large (9.9 m3)</option>
                    </select>
                    @error('type')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="flex justify-end space-x-4 mt-6 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg transition">
                    <i class="fas fa-save mr-2"></i> Save Cylinder
                </button>
            </div>
        </form>
    </div>
