        ...
        <form method="POST" action="{{ route('cylinders.update', $cylinder) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="tare_weight" value="{{ old('tare_weight', $cylinder->tare_weight) }}"
                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('tare_weight')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="current_gas_quantity" value="{{ old('current_gas_quantity', $cylinder->current_gas_quantity) }}"
                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="last_hydro_test_date" value="{{ old('last_hydro_test_date', $cylinder->last_hydro_test_date?->format('Y-m-d')) }}"
                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="next_hydro_test_date" value="{{ old('next_hydro_test_date', $cylinder->next_hydro_test_date?->format('Y-m-d')) }}"
                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
